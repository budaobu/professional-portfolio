...
export default function ArticlesIndex({ articles }) {
  return (
    <>
      <Head>
        <title>Articles - Joey Hu</title>
        <meta
          name="description"
          content="All of my long-form thoughts on AI coding, prompt engineering, product design, and more, collected in chronological order."
        />
      </Head>
      <SimpleLayout
